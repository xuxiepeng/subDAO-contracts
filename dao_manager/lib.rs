...
//    use github::Github;
    ...
    impl DAOManager {
        ...
        fn _init_base(&mut self, base_code_hash: Option<&Hash>,
                      base_name: String, base_logo: String, base_desc: String, version: u32) -> bool {
        ...
        /// init erc20
        fn _init_erc20(&mut self, erc20_code_hash: Option<&Hash>, name: String, symbol: String, initial_supply: u64, decimals: u8, version: u32) -> bool {
        ...
        /// init org
        fn _init_org(&mut self, org_code_hash: Option<&Hash>, version: u32) -> bool {
